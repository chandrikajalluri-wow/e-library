                ...
                <div className={`nav-actions-icons ${isMenuOpen ? 'mobile-show' : ''}`}>
                    ...
                    {role === RoleName.ADMIN && (
                        <>
                            ...
                            <NavIcon className="mobile-only" to="/admin-dashboard?tab=user-requests" label="Book Requests" icon={<FileQuestion size={20} />} />
                            <NavIcon className="mobile-only" to="/admin-dashboard?tab=read-history" label="Read History" icon={<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>} />
                            ...
                            <div className="nav-more-dropdown-container desktop-only">
                                ...
                                {isMoreOpen && (
                                    <div className="profile-dropdown-menu nav-more-dropdown-menu">
                                        <DropdownItem to="/admin-dashboard?tab=user-requests" label="Book Requests" icon={<FileQuestion size={16} />} />
                                        <DropdownItem to="/admin-dashboard?tab=read-history" label="Read History" icon={<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>} />
