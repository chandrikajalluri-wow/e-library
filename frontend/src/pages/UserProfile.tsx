...
import { getProfile, updateProfile, changePassword, requestBook } from '../services/userService';
...
const UserProfile: React.FC = () => {
    ...
    const [bookRequest, setBookRequest] = useState({ title: '', author: '', reason: '' });
    ...
    return (
        <div className="profile-container">
            ...
            <div className="card profile-card">
                ...
                {!isEditing ? (
                    <div>
                        <p className="profile-detail-row"><strong>Name:</strong> {user.name}</p>
                        <p className="profile-detail-row"><strong>Email:</strong> {user.email} (Read-only)</p>
                        <button className="btn-primary" onClick={() => setIsEditing(true)}>Edit Name</button>
                    </div>
                ) : (
                    <form onSubmit={handleUpdateProfile} className="profile-edit-form">
                        ...
                        <p className="profile-email-readonly"><strong>Email:</strong> {user.email} (Read-only)</p>
            ...
            <div className="card profile-card">
                ...
                <p className="profile-info-text">Can't find a book? Suggest it to our library admins.</p>
                <form onSubmit={handleBookRequest}>
                    ...
                    <div className="form-group">
                        ...
                        <textarea
                            ...
                            onChange={(e) => setBookRequest({ ...bookRequest, reason: e.target.value })}
                            rows={3}
