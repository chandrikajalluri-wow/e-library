...
const NotificationsPage: React.FC = () => {
    ...
    return (
        <div className="notifications-page saas-container saas-reveal">
            ...
            <div className="notifications-container card-saas">
                {notifications.length > 0 ? (
                        ...
                        {notifications.map((notif) => (
                            ...
                            >
                                <div className="notif-full-icon">
                                    {notif.type === 'borrow' && <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" strokeWidth="2"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v10.5M4 19.5H20M4 19.5A2.5 2.5 0 0 0 6.5 22H20v-5.5"></path></svg>}
                                ...
                                <div className="notif-full-content">
                                    ...
                                    {notif.book_id && (
                                        <div className="notif-book-info">
                                            <p>Related Book: <strong>{notif.book_id.title}</strong></p>
                    ...
                    <div className="empty-notifications" style={{ textAlign: 'center', padding: '4rem 2rem' }}>
                        <div style={{ background: 'var(--bg-secondary)', width: '80px', height: '80px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1.5rem auto' }}>
                        ...
                        <Link to="/books" className="btn-primary" style={{ marginTop: '1.5rem', display: 'inline-block', textDecoration: 'none' }}>
                            Explore Books
                        </Link>
                    </div>
                )}
            ...
            <style>{`
                ...
                @keyframes pulse {
                    ...
                    70% { transform: scale(1); box-shadow: 0 0 0 10px rgba(var(--accent-primary-rgb), 0); }
