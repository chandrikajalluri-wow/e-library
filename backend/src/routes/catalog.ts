...
router.get('/categories', cacheMiddleware('cat:all', 600), catalogController.getAllCategories);
...
router.get('/books/recommendations', auth, cacheMiddleware('book:rec', 600, true), catalogController.getRecommendedBooks);
