...
// 1. Mock all dependencies BEFORE importing app
...
// Setup mocks for sessionManager exports
const sessionManager = require('../../src/utils/sessionManager');
sessionManager.isValidSession.mockResolvedValue(true);
sessionManager.isTokenBlacklisted.mockResolvedValue(false);
sessionManager.saveSession.mockResolvedValue(true);
